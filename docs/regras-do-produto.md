...
- Documentação de apoio: [análise mensal](tecnico/analise-mensal.md), [persistência](tecnico/persistencia-local.md), [repository/análise](tecnico/repository-analise-mensal.md), [application state](historico/feat-04-application-state.md), [Dashboard](historico/feat-05-monthly-dashboard.md), [cadastro](historico/FEAT-06.md), [recorrências](historico/FEAT-07.md), [Histórico](historico/FEAT-08.md), [detalhamento](historico/FEAT-09.md), [gráficos](historico/FEAT-10.md) e [revisão pré-FEAT 11](historico/PRE-FEAT-11-UX-REVIEW.md).
